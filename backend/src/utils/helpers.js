...
/**
 * Generate unique personal QR code for team encounters
 * Uses a different prefix to distinguish from checkpoint QR codes
 */
export function generatePersonalQRCode() {
  const prefix = 'COOPTEAM';
...
/**
 * Check if a QR code is a personal team QR (vs checkpoint QR)
 */
export function isPersonalQRCode(qrCode) {
